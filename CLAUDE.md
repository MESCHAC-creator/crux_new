...
**Quand les utiliser:**
- `orchestrator` → sprint planning, feature prioritization
- `architect` → architecture changes, major technical decisions
- `engineer` → complex implementation, PR review
- `designer` → new screens, design system, accessibility
- `qa` → before each push, critical code review, missing tests